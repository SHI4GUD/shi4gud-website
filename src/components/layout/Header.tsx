...
const Header = forwardRef<HTMLElement, HeaderProps>(({ isSticky }, ref) => {
  ...
  const navLinks = [
    ...
    { href: '/videos', text: 'Videos', icon: <TvMinimalPlay className="w-4 h-4" /> },
  ...
  const socialLinks = [
    ...
    { href: 'https://t.me/newShinaTokenPortal', icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 15 15" stroke="currentColor" strokeLinejoin="round">
        <path d="M14.5 1.5l-14 5 4 2 6-4-4 5 6 4 2-12z"></path>
      </svg>
    )},
